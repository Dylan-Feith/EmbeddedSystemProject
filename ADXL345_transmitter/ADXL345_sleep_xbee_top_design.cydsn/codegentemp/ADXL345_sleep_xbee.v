// ======================================================================
// ADXL345_sleep_xbee.v generated from TopDesign.cysch
// 03/29/2016 at 08:50
...
module top ;
    ...
    UART_v2_50_1 zigbee (
        ...
        .rx_data(Net_55),
        .rx_clk(Net_56));
    defparam zigbee.Address1 = 0;
    defparam zigbee.Address2 = 0;
    defparam zigbee.EnIntRXInterrupt = 0;
    defparam zigbee.EnIntTXInterrupt = 0;
    defparam zigbee.FlowControl = 0;
    defparam zigbee.HalfDuplexEn = 0;
    defparam zigbee.HwTXEnSignal = 0;
    defparam zigbee.NumDataBits = 8;
    defparam zigbee.NumStopBits = 1;
    defparam zigbee.ParityType = 0;
    defparam zigbee.RXEnable = 0;
    defparam zigbee.TXEnable = 1;
	...
	wire [0:0] tmpOE__Pin_gestion_sleep_xbee_net;
	wire [0:0] tmpFB_0__Pin_gestion_sleep_xbee_net;
	wire [0:0] tmpIO_0__Pin_gestion_sleep_xbee_net;
	wire [0:0] tmpINTERRUPT_0__Pin_gestion_sleep_xbee_net;
	electrical [0:0] tmpSIOVREF__Pin_gestion_sleep_xbee_net;
	...
	cy_psoc3_pins_v1_10
		...
		Pin_gestion_sleep_xbee
		 (.oe(tmpOE__Pin_gestion_sleep_xbee_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_gestion_sleep_xbee_net[0:0]}),
		  .io({tmpIO_0__Pin_gestion_sleep_xbee_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_gestion_sleep_xbee_net),
		  .interrupt({tmpINTERRUPT_0__Pin_gestion_sleep_xbee_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_gestion_sleep_xbee_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
